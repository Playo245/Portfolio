...
enum BookGenre {
    ...
    History(7),
    /** this is the fantasy enum */
    Romance(8),
    /** this is the horror enum */
    Horror(9),
    /** this is the comedy enum */
    Comedy(10),
    /** this is the drama enum */
    Drama(11),
    /** this is the poetry enum */
    Poetry(12),
    /** this is the travel enum */
    Travel(13),
    /** this is the self-help enum */
    SelfHelp(14),
    /** this is the science enum */
    Science(15);
...
class Book implements BookIntreface {
    ...
    */
    public static void main(String[] args) {
        Book b1 = new Book("The Name of the Wind", "Patrick Rothfuss", BookGenre.Fantasy);
        System.out.println(b1);
        Book b2 = new Book("Dune", "Frank Herbert", BookGenre.SciFi, 1965);
        System.out.println(b2);
        Book b3 = new Book("The Girl with the Dragon Tattoo", "Stieg Larsson", BookGenre.Mystery, 2005, 2019, BookMedium.Paperback, BookRating.Rating4);
