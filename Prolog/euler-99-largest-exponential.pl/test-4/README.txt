...
- `euler-99-largest-exponential.pl` - The Go source code for solving the problem.
...
$ swipl -s euler-99-largest-exponential.pl -- numbers.txt numbers-2.txt
Usage: swipl -s euler-99-largest-exponential.pl <filename>
