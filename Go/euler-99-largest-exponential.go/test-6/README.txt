...
- `euler-99-largest-exponential.go` - The Go source code for solving the problem.
...
$ go run euler-99-largest-exponential.go numbers.txt
Error occurred, couldn't convert to integers: strconv.Atoi: parsing "56940d": invalid syntax
