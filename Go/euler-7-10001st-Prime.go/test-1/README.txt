...
This project aims to solve the Euler 7 problem (https://projecteuler.net/problem=7). The goal is to find the 10001st Prime number

Project Structure
-----------------

- `euler-7-10001st-Prime.go` - The Go source code for solving the problem.
